...
const Footer = () => {
    ...
    return (
        <div className='bg-richblack-800'>
            <div className='w-11/12 mx-auto flex justify-between items-start text-richblack-400 pt-14 pb-5 border-b-[1px] border-richblack-700'>
                {/* Left container */}
                <div className='w-[50%] flex flex-row gap-14'>
                    {/* section 1 */}
                ...
                {/* Right container */}
                <div className='w-[50%] pl-[30px] pb-[20px] flex flex-row justify-between border-l-[1px] border-richblack-700'>
                    {/* Section 1 - Subjects */}
                    <div className='flex flex-col gap-[10px]'>
                        <div className='font-semibold text-richblack-100'>
                            Subjects
            ...
            <div className='w-11/12 mx-auto flex justify-between my-12'>
