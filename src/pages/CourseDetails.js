    ...
    return (
        <div>
            <div className="bg-richblack-800">
                <div className="relative max-w-maxContent mx-auto px-2 flex flex-col gap-4 py-32 text-richblack-5">
                    <p className="w-[48%] text-4xl font-bold text-richblack-5">
                        {courseData?.courseDetails?.courseName}
                    </p>
                    <p className="w-[48%] text-richblack-200 text-lg">
                    ...
                    <div className="text-lg flex items-center gap-2 flex-wrap">
                        ...
                        <p className="pt-1">{`${courseData?.courseDetails?.studentsEnrolled?.length} students enrolled`}</p>
                    </div>
                    <p className="text-lg">
                        {`Created By
            ...
            <div className="bg-richblack-900">
                <div className="max-w-maxContent mx-auto px-2 text-richblack-5 mb-16">
